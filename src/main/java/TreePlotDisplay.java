...
public class TreePlotDisplay extends javax.swing.JFrame {
    ...
    public TreePlotDisplay(Graph graph) {
        this.graph = graph;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1 = new SpanningTreePrinter(graph);
...
//            java.util.logging.Logger.getLogger(TreePlotDisplay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new TreePlotDisplay().setVisible(true);
//            }
//        });
//    }
